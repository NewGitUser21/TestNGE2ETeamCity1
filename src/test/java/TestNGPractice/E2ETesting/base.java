...
public class base {
	...
	public static WebDriver initializeDriver() throws IOException, InterruptedException, WebDriverException, SocketTimeoutException   //void changed to WebDriver
	{
		...
		//src\test\java\TestNGPractice\E2ETesting\data.properties
		//This****3rd way to use base properties file***********
		String directoryPath = System.getProperty("user.dir");
		FileInputStream fis = new FileInputStream(directoryPath+"/src/test/java/TestNGPractice/E2ETesting/data.properties");
