...
public class CallStoredProc {
	...
	public static void main(String[] args) throws SQLException {
		...
		CallableStatement s = (CallableStatement) con.prepareCall("{CALL `employeeportal`.`GetManagerID`(?, ?)}");
		...
		s.setString(1, "101349");
		
		s.execute();
		
		String ManagerID = s.getString("ManagerID");
		
		System.out.println("Employee Supervisor ID: " + ManagerID);
